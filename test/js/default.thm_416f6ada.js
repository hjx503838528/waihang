window.skins={};
	...
	_proto.iconDisplay_i = function () {
		...
		t.left = 0;
		t.right = 0;
		t.scale9Grid = new egret.Rectangle(57,33,19,25);
		t.source = "kuang_6";
		t.y = 0;
		return t;
	};
	...
	function ZxTaskViewSkin1() {
		_super.call(this);
		this.skinParts = ["shade","titleTxt","shareBtn","refreshBtn","nameTxt","hintTxt","zxstartBtn","closeBtn"];
		
		this.height = 1334;
		this.width = 750;
		this.elementsContent = [this.shade_i(),this._Group2_i()];
	}
	var _proto = ZxTaskViewSkin1.prototype;
	...
	_proto._Group2_i = function () {
		...
		t.horizontalCenter = 0;
		t.verticalCenter = 0;
		t.elementsContent = [this._Image1_i(),this._Group1_i(),this._Image3_i(),this.shareBtn_i(),this.refreshBtn_i(),this.nameTxt_i(),this.hintTxt_i(),this.zxstartBtn_i(),this.closeBtn_i()];
		return t;
	};
	_proto._Image1_i = function () {
		var t = new eui.Image();
	...
	_proto._Group1_i = function () {
		...
		t.horizontalCenter = 0;
		t.y = 120;
		t.elementsContent = [this._Image2_i(),this.titleTxt_i()];
		return t;
	};
	_proto._Image2_i = function () {
		var t = new eui.Image();
	...
	return ZxTaskViewSkin1;
})(eui.Skin);generateEUI.paths['resource/skins/branch/ZxTaskViewSkin2.exml'] = window.ZxTaskViewSkin2 = (function (_super) {
	__extends(ZxTaskViewSkin2, _super);
	function ZxTaskViewSkin2() {
		_super.call(this);
		this.skinParts = ["shade","titleTxt","list","numTxt","nextBtn","startBtn","zhuCon","shareBtn","refreshBtn","awardNameTxt","closeBtn"];
		
		this.height = 1334;
		this.width = 750;
		this.elementsContent = [this.shade_i(),this._Group2_i()];
	}
	var _proto = ZxTaskViewSkin2.prototype;
	...
	_proto._Group2_i = function () {
		...
		t.horizontalCenter = 0;
		t.verticalCenter = 0;
		t.elementsContent = [this._Image1_i(),this.zhuCon_i(),this.shareBtn_i(),this.refreshBtn_i(),this.awardNameTxt_i(),this.closeBtn_i()];
		return t;
	};
	_proto._Image1_i = function () {
		var t = new eui.Image();
	...
	_proto.zhuCon_i = function () {
		...
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this.titleTxt_i(),this._Group1_i(),this._Image3_i(),this.numTxt_i(),this.nextBtn_i(),this.startBtn_i()];
		return t;
	};
	_proto.titleTxt_i = function () {
		var t = new eui.Label();
	...
	return GameSkin;
})(eui.Skin);generateEUI.paths['resource/skins/item/GkItemSkin.exml'] = window.GkItemSkin = (function (_super) {
	__extends(GkItemSkin, _super);
	function GkItemSkin() {
		_super.call(this);
		this.skinParts = ["iconDisplay2","iconDisplay","labelDisplay","stateImg"];
		
		this.height = 100;
		this.width = 125;
		this.elementsContent = [this.iconDisplay2_i(),this.iconDisplay_i(),this.labelDisplay_i(),this.stateImg_i()];
	}
	var _proto = GkItemSkin.prototype;

	_proto.iconDisplay2_i = function () {
		var t = new eui.Image();
		this.iconDisplay2 = t;
		t.left = -10;
	...
	function GuanKaSkin() {
		_super.call(this);
		this.skinParts = ["treeCon","btn0","btn1","btn2","btn3","btn4","btn5","btn6","btn7","btn8","btn9","btn10","btn11","btn12","btn13","btn14","btn15","btn16","btn17","btn18","btn19","btn20","btn21","btn22","btn23","btn24","btn25","btn26","btn27","btn28","btn29"];
	...
	_proto._Group5_i = function () {
		...
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this._Image1_i(),this._Image2_i(),this._Image3_i(),this._Image4_i(),this.treeCon_i(),this._Group1_i(),this._Group2_i(),this._Group3_i(),this._Group4_i()];
		return t;
	};
	_proto._Image1_i = function () {
		var t = new eui.Image();
	...
	_proto.treeCon_i = function () {
		var t = new eui.Group();
		this.treeCon = t;
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this._Image5_i(),this._Image6_i(),this._Image7_i(),this._Image8_i(),this._Image9_i(),this._Image10_i(),this._Image11_i(),this._Image12_i(),this._Image13_i(),this._Image14_i(),this._Image15_i(),this._Image16_i(),this._Image17_i(),this._Image18_i()];
		return t;
	};
	_proto._Image5_i = function () {
		var t = new eui.Image();
	...
	_proto._Group3_i = function () {
		...
		t.width = 600;
		t.y = 0;
		t.elementsContent = [this._Image60_i(),this._Image61_i(),this._Image62_i(),this._Image63_i(),this._Image64_i(),this._Image65_i(),this._Image66_i(),this._Image67_i(),this._Image68_i(),this._Image69_i(),this._Image70_i(),this._Image71_i(),this._Image72_i()];
		return t;
	};
	...
	_proto._Group4_i = function () {
		...
		t.horizontalCenter = 0;
		t.width = 600;
		t.elementsContent = [this._GkItem1_i(),this._GkItem2_i(),this._GkItem3_i(),this._GkItem4_i(),this._GkItem5_i(),this._GkItem6_i(),this._GkItem7_i(),this._GkItem8_i(),this._GkItem9_i()];
		return t;
	};
	_proto._GkItem1_i = function () {
		var t = new GkItem();
		t.skinName = "GkItemSkin";
		t.x = 237.5;
		t.y = 50;
	...
	_proto.timeTxt_i = function () {
		...
		t.fontFamily = "黑体";
		t.size = 22;
		t.text = "有效期：2019/02/01-2019/03/31";
		t.textColor = 0x666666;
		t.touchEnabled = false;
		t.x = 30;
		return t;
	...
	function QiPaoItemSkin() {
		_super.call(this);
		this.skinParts = ["bgImg","iconImg","titleTxt"];
		
		this.height = 135;
		this.width = 114;
		this.elementsContent = [this._Group1_i()];
	}
	var _proto = QiPaoItemSkin.prototype;
	...
	_proto._Group1_i = function () {
		...
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this.bgImg_i(),this.iconImg_i(),this.titleTxt_i()];
		return t;
	};
	...
	function MapSkin() {
		_super.call(this);
		this.skinParts = ["bgCon","treesCon","gdCon","btnCon","awardCon","mainCon","scroller"];
	...
	_proto.mainCon_i = function () {
		var t = new eui.Group();
		this.mainCon = t;
		t.elementsContent = [this.bgCon_i(),this.treesCon_i(),this.gdCon_i(),this.btnCon_i(),this.awardCon_i()];
		return t;
	};
...
})(eui.Skin);generateEUI.paths['resource/skins/win/DailyTaskSkin.exml'] = window.DailyTaskSkin = (function (_super) {
...
})(eui.Skin);generateEUI.paths['resource/skins/win/FriendHelpSkin.exml'] = window.FriendHelpSkin = (function (_super) {
	...
	function ResultSkin() {
		_super.call(this);
		this.skinParts = ["dong","shade","gbg","zhun1","zhuan","iconImg","contentTxt"];
		
		this.height = 1334;
		this.width = 750;
		this.dong_i();
		this.elementsContent = [this.shade_i(),this.gbg_i(),this.zhun1_i(),this.zhuan_i(),this.iconImg_i(),this.contentTxt_i()];
		
		eui.Binding.$bindProperties(this, ["zhun1"],[0],this._TweenItem1,"target");
		eui.Binding.$bindProperties(this, [180],[],this._Object1,"rotation");
	}
	var _proto = ResultSkin.prototype;

	_proto.dong_i = function () {
		var t = new egret.tween.TweenGroup();
		this.dong = t;
	...
	return SignInSkin;
})(eui.Skin);generateEUI.paths['resource/skins/win/TaskViewSkin.exml'] = window.TaskViewSkin = (function (_super) {
	__extends(TaskViewSkin, _super);
	function TaskViewSkin() {
		_super.call(this);
		this.skinParts = ["shade","titleTxt","list","txList","numTxt","renwuCon","nextBtn","startBtn","zhuCon","shareBtn","refreshBtn","awardNameTxt","closeBtn"];
	...
	_proto.zhuCon_i = function () {
		...
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this.titleTxt_i(),this._Group1_i(),this._Image3_i(),this.renwuCon_i(),this.nextBtn_i(),this.startBtn_i()];
		return t;
	};
	_proto.titleTxt_i = function () {
		var t = new eui.Label();
